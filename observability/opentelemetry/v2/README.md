...
If you want to get a fully instrumented HTTP client, use the helper method in the ` github.com/Yangfisher1/ce-go-sdk/observability/opentelemetry/v2` module:
...
This will produce spans for all outgoing and incoming requests. By default, the spans will have the attributes as defined in [keys.go](https://github.com/Yangfisher1/ce-go-sdk/blob/release-2.5/v2/observability/keys.go). For more advanced configuration, see the next section.
...
<table>
  <tbody>
	...
	<tr>
	  ...
	  <td>The attributes as defined in <a href="https://github.com/Yangfisher1/ce-go-sdk/blob/release-2.5/v2/observability/keys.go">keys.go</a></td>
	</tr>
  </tbody>
</table>
